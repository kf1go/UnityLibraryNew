...
public static class TestTween
{
    ...
    {
        static void CrossFadeColor(Color targetColor, float duration, bool ignoreTimeScale, bool useAlpha, bool useRGB)
        {
            //if (canvasRenderer == null || (!useRGB && !useAlpha))
            //    return;

            Color currentColor = default;// canvasRenderer.GetColor();
            ...
            ColorTween colorTween = default;//new ColorTween {duration = duration, startColor = canvasRenderer.GetColor(), targetColor = targetColor};
